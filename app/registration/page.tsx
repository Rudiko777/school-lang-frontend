...
import { UserProps } from '@/processes/redux/FeaturesCourses/User.slice.ts'
...
const Page = () => {
    ...
    const handleClick = async () => {
        ...
        const response = await fetch(
            'http://localhost:8080/api/v1/apps/registration',
            {
                method: 'POST',
    ...
    return (
        <div className={styles.content}>
            ...
            <div className={styles.registrationTitle}>
                <Htag type={'h2-titleBlock'}>Регистрация</Htag>
