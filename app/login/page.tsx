        ...
        <div className={styles.block}>
            <div className={styles.contentLogin}>
                ...
                <div className={styles.loginTitle}>
                    <Htag type={'h2-titleBlock'}>Вход в кабинет</Htag>
                    <Ptag type={'medium'}>Введите данные учётной записи</Ptag>
                </div>
                <div className={styles.loginActions}>
                    <Input
                        placeholder={'Test или test@mail.ru'}
                        inputSize={'small'}
                        state={'default'}
                        type={'tel'}
                ...
                <div className={styles.or}>
                    <span className={styles.orLeft}></span>
                    <span className={styles.orContent}>или</span>
                    <span className={styles.orRight}></span>
                </div>
